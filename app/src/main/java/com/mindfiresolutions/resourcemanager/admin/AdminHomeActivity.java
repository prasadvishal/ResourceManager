...
public class AdminHomeActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener, ApiCallHandler.Listener {


    private final static String TAG = AdminHomeMainActivity.class.getSimpleName();
    private final String GET_USER_DETAILS = "GetUserDetails";
    ...
    private void makeDrawer() {
        ...
        toolbar.setSubtitle(getString(R.string.title_activity_home));
    ...
    void changeNavigationView(View view) {
        ...
        ImageView admin_dp = (ImageView)admin_view.findViewById(R.id.nav_drwr_user_img);
        //TODO complete admin name here
        admin_txt.setText(SharedPref.getInstance(this).getSharedPreferences(NAMEKEY)); //Done

        Picasso.with(this).load("http://203.92.41.80:9093/" + SharedPref.getInstance(this).getSharedPreferences(IMG_URL))//TODO trim base url
                .placeholder(R.drawable.placeholder)   // optional
                .error(R.drawable.no_image)      // optional
                .fit()
                .into(admin_dp, new com.squareup.picasso.Callback() {
                    @Override
                    public void onSuccess() {
                        //LoggerUtility.toastLong(AdminHomeActivity.this, getString(R.string.successful_registeration));
                    }

                    @Override
                    public void onError() {
                       // LoggerUtility.toastLong(AdminHomeActivity.this, getString(R.string.nothing_selected));
                    }
                });
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case (R.id.admin_software):
                Intent intentSoftwareList = new Intent(AdminHomeActivity.this, SoftwareSummaryActivity.class);
                startActivity(intentSoftwareList);
                overridePendingTransition(R.anim.slide_from_right, R.anim.slide_to_left);
                break;
            case (R.id.admin_shared_resource):
                Intent intentSharedResList = new Intent(AdminHomeActivity.this, SharedResourceSummaryActivity.class);
