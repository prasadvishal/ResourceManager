...
public class UserResourceDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = UserResourceDetailActivity.class.getSimpleName();
    private int mRequestId, mCategoryId;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_resource_details);
        initViews();
        fillData();
    ...
    private void fillData() {
        ...
        mRequestedTo.setText( i.getExtras().getString(ASSIGNED_BY));
    ...
    public void onClick(View v) {
        ...
        {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(UserResourceDetailActivity.this);
            alertDialogBuilder.setTitle(R.string.cnfrm_release); //TODO REmove Hardcoded strings //DONE
            // set dialog message
            alertDialogBuilder
                    .setMessage(R.string.promt_release_resource_confirmation)
                    .setCancelable(false)
                    .setPositiveButton("Yes",new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog,int id) {
                            // if this button is clicked, close
                            makeReleaseResourceAPICall();
    ...
    private void makeReleaseResourceAPICall() {

//        final String token = CheckForExpiry.checkForToken(this);
//        final ProgressDialog progressDialog = new ProgressDialog(UserResourceDetailActivity.this);
...
//                                     Intent i = new Intent(UserResourceDetailActivity.this, HomeActivity.class);
//                                     UserResourceDetailActivity.this.finish();
//                                     startActivity(i);
